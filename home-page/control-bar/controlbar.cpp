...
ControlBar::ControlBar(QWidget *parent) :
		QWidget(parent), main_layout(nullptr), scan_button(nullptr), stop_button(nullptr), pause_button(nullptr), resume_button(nullptr), scan_areas_controller_button(nullptr) {
